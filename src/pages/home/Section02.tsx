...
export function Section02() {
    return (
        <div className="grid md:grid-rows-2 md:grid-cols-2 w-screen h-full">
            {/* DIV 1 */}
            <div className="bg-[#f4f4f4] flex items-center justify-center order-1 md:row-start-1 md:col-start-1 py-[100px] xl:py-[50px]  px-0 h-fit md:h-full">
                <div className="flex flex-col justify-center items-center w-[80%]">
                    <div className="flex items-start flex-col gap-4 pl-5 border-l-4 border-l-[#082746]">
                        <h2 className="text-2xl xl:text-3xl max-w-[320px]">
                            DEPARTAMENTOS DE 1 Y 3 AMBIENTES
                        </h2>
                        <p className="max-w-[340px] xl:max-w-[500px] text-sm xl:text-lg text-[#1e1e1e]">
            ...
            {/* DIV 2 */}
            <div
                className="w-full min-h-[140vw] md:min-w-0 md:aspect-[641/887] md:min-h-[887px] bg-cover bg-bottom bg-no-repeat py-4 px-4 flex items-center justify-center order-2 md:row-span-2 md:col-start-2"
            ...
            {/* DIV 3 */}
            <div className="bg-[#f4f4f4] md:bg-[#082746]  flex items-center justify-center order-3 md:row-start-2 md:col-start-1 py-[100px] xl:py-[50px] px-0 h-fit md:h-full">
                <div className="flex flex-col justify-center items-center w-[80%]">
                    <div className="flex items-start flex-col gap-4 pl-5 border-l-4 border-l-[#082746] md:border-l-[#f4f4f4]">
                        ...
                        <p className="max-w-[340px] xl:max-w-[500px] text-sm xl:text-lg text-[#1e1e1e] md:text-[#f4f4f4]">
